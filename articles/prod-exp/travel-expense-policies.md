...
description: Bạn có thể thiết lập các chính sách chi phí mà công nhân của bạn phải tuân theo khi nhập và gửi báo cáo chi phí cũng như yêu cầu đi lại trong Microsoft Dynamics 365 Tài chính.
author: suvaidya
ms.date: 05/20/2020
ms.topic: article
ms.prod: ''
