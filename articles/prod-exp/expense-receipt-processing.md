...
description: Bài viết này cung cấp thông tin về xử lý nhận dạng ký tự quang học (OCR) cho biên lai. Tính năng này được thiết kế để cải thiện trải nghiệm người dùng khi báo cáo chi phí được tạo trong Microsoft Dynamics 365 Tài chính.
author: stsporen
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
