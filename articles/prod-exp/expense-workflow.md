...
description: Bài viết này giải thích cách bạn có thể sử dụng hệ thống quy trình làm việc trong Microsoft Dynamics 365 Finance, để thiết lập quy trình xem xét các báo cáo chi phí trong Quản lý chi phí.
