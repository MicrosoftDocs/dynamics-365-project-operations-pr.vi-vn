...
| **Công ty cung cấp nguồn lực** | Đặt theo mặc định từ nguồn thực tế. Trường chỉ đọc bị khóa không cho chỉnh sửa. | Có thể chỉnh sửa trường này trên thông tin chi tiết mô tả hóa đơn mới không được hỗ trợ bởi nguồn thực tế. |
