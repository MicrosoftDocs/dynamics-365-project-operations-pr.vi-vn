...
---
# <a name="estimate-a-projectbased-contract-line"></a>Số liệu ước tính cho phần mô tả hợp đồng dựa trên dự án
...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Tạo trực tiếp số liệu ước tính trong phần mô tả hợp đồng dựa trên dự án
...
| **Công ty cung cấp nguồn lực** | **Tạo nhanh** | Công ty cung ứng nguồn lực hoặc pháp nhân chịu chi phí này và cung cấp nguồn lực để thực hiện. | Trường này mặc định sẽ là thông tin chi tiết mô tả hợp đồng liên quan cho các chi phí được tạo tự động. Trường này cũng được sử dụng trong truy xuất giá vốn. |
