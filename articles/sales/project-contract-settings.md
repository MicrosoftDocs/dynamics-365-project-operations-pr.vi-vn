---
title: Chi tiết của tiêu đề cho các hợp đồng dựa trên dự án
description: Bài viết này cung cấp thông tin về các trường và thông tin về hợp đồng dựa trên dự án trong Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
