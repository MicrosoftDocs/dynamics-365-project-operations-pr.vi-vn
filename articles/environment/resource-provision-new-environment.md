...
2. Trong danh sách **Tính năng xem trước**, hãy chọn **Project Operations** và chọn **Đã bật tính năng xem trước** để kích hoạt Project Operations.
...
1. Mở Dynamics 365 Finance mới [môi trường demo](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/deployment/deploy-demo-environment) hoặc triển khai [môi trường sản xuất/hộp cát](https://docs.microsoft.com/edynamics365/fin-ops-core/dev-itpro/deployment/deployenvironment-newinfrastructure). 
...
| **Thực thể tích hợp Project Operations để ước tính giờ (msdyn\_resourceassignments)** | No | No | Không áp dụng | No | Không áp dụng |
...
5. Tiếp tục chạy bản đồ sau khi quá trình làm mới hoàn tất.

![Làm mới bản đồ](./media/20RefreshMapping.png)

Trước khi bạn bật bản đồ tiếp theo, hãy xác minh rằng bản đồ trong bảng ở trạng thái **Đang chạy**. Việc chạy bản đồ với số lượng điều kiện tiên quyết lớn hơn có thể mất một chút thời gian.
