...
- Sales
     ...
     - Đã sửa lỗi: Các nút phụ cho **Cơ hội mới** , **Báo giá** , **Mô tả đơn hàng** và **Thêm sản phẩm** hiển thị trong các lệnh cho Cơ hội, Báo giá, Sản phẩm đặt hàng và lưới phụ Dòng dựa trên dự án.
