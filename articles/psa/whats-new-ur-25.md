...
description: Bài viết này liệt kê các tính năng và bản sửa lỗi có sẵn trong Bản phát hành bản cập nhật tự động hóa dịch vụ dự án 25, V3.
author: ruhercul
...
Bài viết này liệt kê các tính năng và bản sửa lỗi mới hoặc được thay đổi cho Project Service Automation V3, Bản cập nhật 25 Phiên bản này có số bản dựng là V 3.10.43.76 và thường có sẵn thông qua bản tự cập nhật vào tháng 10 năm 2020.
