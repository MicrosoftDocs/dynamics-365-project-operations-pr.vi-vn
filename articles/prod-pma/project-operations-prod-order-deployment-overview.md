...
description: Bài viết này cung cấp thông tin về loại hình triển khai, Project Operations cho các tình huống dựa trên sản xuất/hàng trữ kho.
author: rumant
ms.date: 11/02/2020
ms.topic: overview
...
- Quản lý bán hàng dựa trên dự án bằng cách sử dụng mô-đun **Bán hàng và tiếp thị** trong ứng dụng tài chính và hoạt động Dynamics 365
- Định giá dự án và chi phí bằng cách sử dụng cấu hình tỷ lệ hóa đơn và tỷ lệ chi phí trong ứng dụng tài chính và hoạt động
- Quản lý nguồn lực của các dự án trong ứng dụng tài chính và hoạt động
- Theo dõi thời gian và tiến độ của dự án trong ứng dụng tài chính và hoạt động
