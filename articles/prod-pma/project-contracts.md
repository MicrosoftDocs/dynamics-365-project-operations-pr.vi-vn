...
description: Bài viết này cung cấp các ví dụ về hợp đồng dự án mà bạn có thể tạo cho các loại dự án và nguồn tiền khác nhau, cũng như cách thức quản lý hợp đồng và lập hóa đơn cho khách hàng trong dự án.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
