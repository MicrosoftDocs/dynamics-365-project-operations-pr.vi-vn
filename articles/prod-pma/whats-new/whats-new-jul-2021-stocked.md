...
description: Bài viết này cung cấp thông tin về các bản cập nhật chất lượng có trong bản phát hành tháng 7 năm 2021 của Hoạt động dự án cho các tình huống dựa trên sản xuất / tồn kho.
author: andchoi
ms.date: 07/01/2021
ms.topic: article
ms.prod: ''
