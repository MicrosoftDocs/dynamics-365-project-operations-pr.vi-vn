...
description: Bài viết này cung cấp thông tin về các bản cập nhật chất lượng có trong bản phát hành tháng 7 năm 2021 của Project Operations cho các kịch bản dựa trên hàng trữ kho/sản xuất.
author: andchoi
ms.date: 07/01/2021
ms.topic: article
ms.prod: ''
