---
title: Có gì mới hoặc thay đổi trong Hoạt động dự án, tháng 9 năm 2021 đối với các kịch bản dựa trên sản xuất / tồn kho
description: Chủ đề này cung cấp thông tin về các bản cập nhật chất lượng có sẵn trong bản phát hành tháng 9 năm 2021 của Hoạt động dự án cho các kịch bản dựa trên sản xuất / tồn kho.
author: andchoi
ms.date: 11/11/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8582046"
---
# <a name="whats-new-or-changed-in-project-operations-september-2021-for-stockedproduction-based-scenarios"></a>Có gì mới hoặc thay đổi trong Hoạt động dự án, tháng 9 năm 2021 đối với các kịch bản dựa trên sản xuất / tồn kho
...
| Quản lý dự án và kế toán | [537214](https://fix.lcs.dynamics.com/Issue/Details/?bugId=537214) | Vấn đề làm tròn thuế giá trị gia tăng (VAT) xảy ra trong khi giấy báo có được thanh toán với hóa đơn ban đầu của dự án. |
...
| Quản lý dự án và kế toán | [564701](https://fix.lcs.dynamics.com/Issue/Details/?bugId=564701) | Thuế có điều kiện không được tính toán chính xác cho lần thanh toán cuối cùng khi việc giữ lại và trả trước của nhà cung cấp được áp dụng cho các hóa đơn đặt hàng. |
...
| Quản lý dự án và kế toán | [578327](https://fix.lcs.dynamics.com/Issue/Details/?bugId=578327) | Khi bạn chọn **Kích thước tài chính đặt** trên một đề xuất hóa đơn, lỗi sau xảy ra: "Không thể truyền đối tượng thuộc loại 'Dynamics.AX .Application.FormIntControl 'để nhập' Dynamics.AX .Application.FormStringControl '. " |
