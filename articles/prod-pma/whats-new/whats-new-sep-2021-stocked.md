...
| Quản lý dự án và kế toán | [578327](https://fix.lcs.dynamics.com/Issue/Details/?bugId=578327) | Khi bạn chọn **Kích thước tài chính đặt** trên một đề xuất hóa đơn, lỗi sau xảy ra: "Không thể truyền đối tượng thuộc loại 'Dynamics.AX.Application.FormIntControl' thành loại 'Dynamics.AX.Application.FormStringControl'." |
...
| Quản lý dự án và kế toán | [584519](https://fix.lcs.dynamics.com/Issue/Details/?bugId=584519) | Không thể cập nhật trạng thái của bảng chấm công thành **Bản nháp** khi quy trình làm việc bị mắc kẹt trong một **Đã hủy** tiểu bang. |
...
| Đi lại và chi tiêu | [571334](https://fix.lcs.dynamics.com/Issue/Details/?bugId=571334) | Lỗi xảy ra khi bạn thay đổi loại chi phí thành **Cá nhân**. |
