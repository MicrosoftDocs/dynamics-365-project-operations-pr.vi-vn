---
title: Có gì mới hoặc thay đổi trong Hoạt động dự án, tháng 9 năm 2021 cho các kịch bản dựa trên sản xuất / tồn kho
description: Bài viết này cung cấp thông tin về các bản cập nhật chất lượng có sẵn trong bản phát hành tháng 9 năm 2021 của Hoạt động dự án cho các tình huống dựa trên sản xuất / tồn kho.
author: andchoi
ms.date: 11/11/2021
ms.topic: article
ms.prod: ''
...
---
# <a name="whats-new-or-changed-in-project-operations-september-2021-for-stockedproduction-based-scenarios"></a>Có gì mới hoặc thay đổi trong Hoạt động dự án, tháng 9 năm 2021 cho các kịch bản dựa trên sản xuất / tồn kho
...
| Quản lý dự án và kế toán | [537214](https://fix.lcs.dynamics.com/Issue/Details/?bugId=537214) | Vấn đề làm tròn thuế giá trị gia tăng (VAT) xảy ra trong khi giấy báo có được thanh toán dựa trên hóa đơn gốc của dự án. |
...
| Quản lý dự án và kế toán | [546265](https://fix.lcs.dynamics.com/Issue/Details/?bugId=546265) | Các **Giá bán hàng giờ** nhóm giá không được tính toán trên cơ cấu phân tích công việc cho báo giá dự án. |
...
| Quản lý dự án và kế toán | [564701](https://fix.lcs.dynamics.com/Issue/Details/?bugId=564701) | Thuế có điều kiện không được tính toán chính xác cho lần thanh toán cuối cùng khi áp dụng việc giữ lại nhà cung cấp và thanh toán trước cho các hóa đơn đặt hàng. |
...
| Quản lý dự án và kế toán | [581167](https://fix.lcs.dynamics.com/Issue/Details/?bugId=581167) | Các **Hóa đơn dự án** báo cáo bỏ qua các dòng. |
...
| Quản lý dự án và kế toán | [586303](https://fix.lcs.dynamics.com/Issue/Details/?bugId=586303) | Mô tả từ đơn đặt hàng có danh mục chi phí không được truy xuất trong danh sách giao dịch dự án đã đăng. |
...
| Quản lý dự án và kế toán | [586034](https://fix.lcs.dynamics.com/Issue/Details/?bugId=586034) | Khi bạn cố gắng thay đổi số tiền trên hóa đơn đã tạo từ đơn đặt hàng, lỗi sau xảy ra: "Các giao dịch trên phiếu mua hàng không cân bằng theo XX / XX / XXXX. (đơn vị tiền tệ kế toán: 0,00 - đơn vị tiền tệ báo cáo: 0,01)." |
| Quản lý dự án và kế toán | [588714](https://fix.lcs.dynamics.com/Issue/Details/?bugId=588714) | Có vấn đề về hiệu suất khi một đề xuất hóa đơn dự án được đăng ở chế độ hàng loạt, vì kết hợp với **GeneralJournalAccountEntry**. |
...
| Quản lý dự án và kế toán | [603320](https://fix.lcs.dynamics.com/Issue/Details/?bugId=603320) | Khi mà **Nâng cao hiệu suất lập kế hoạch tài nguyên dự án** tính năng được bật, các giá trị thập phân được làm tròn không chính xác đối với khả năng cung cấp tài nguyên và dung lượng. |
...
| Đi lại và chi tiêu | [574252](https://fix.lcs.dynamics.com/Issue/Details/?bugId=574252) | Chính sách chi phí cho các giao dịch liên công ty có ID dự án không hoạt động chính xác. |
