...
|--------------|------------------|----------------|
| Quản lý dự án và kế toán | [557017](https://fix.lcs.dynamics.com/Issue/Details/?bugId=557017) | Dự án đang làm việc trong quá trình (WIP) và số tiền doanh thu tích lũy không được hoàn nguyên chính xác khi hóa đơn khách hàng liên công ty được đăng. |
...
| Quản lý dự án và kế toán | [583873](https://fix.lcs.dynamics.com/Issue/Details/?bugId=583873) | Báo cáo chi phí liên công ty có các Khoản phải trả liên công ty đang chờ xử lý chi phí hóa đơn của nhà cung cấp lần đầu tiên được đăng lên **Dự án WIP chi phí** kiểu đăng. Tuy nhiên, trong quá trình xử lý, các chi phí liên quan đến ước tính được đăng lên **Chi phí dự án** loại đăng thay vì loại dự kiến **Chi phí liên công ty** kiểu đăng. |
