...
## <a name="find-a-project"></a>Tìm dự án  
 ...
 ![Danh sách các dự án phù hợp với kỹ năng trong ứng dụng Tìm kiếm Dự án dành cho Thiết bị di động](../project-service/media/project-service-project-finder-list.png "Danh sách các dự án phù hợp với kỹ năng trong ứng dụng Tìm kiếm Dự án dành cho Thiết bị di động")  
...
## <a name="update-your-skills"></a>Cập nhật các kỹ năng của bạn  
 ...
 ![Nút cấu hình trong ứng dụng Tìm kiếm Dự án dành cho Thiết bị di động](../project-service/media/project-service-project-finder-profile.png "Nút cấu hình trong ứng dụng Tìm kiếm Dự án dành cho Thiết bị di động")  
