...
Tìm kiếm nguồn lực để trợ giúp việc hoạch định triển khai? Tìm hiểu các hướng dẫn có thể tải xuống này.
 ...
 [Hướng dẫn hoạch định và theo dõi dự án](../project-service/implementation-guides/project-planning-tracking.md)

 [Hướng dẫn báo giá, định giá và thanh toán cơ bản](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [Hướng dẫn báo giá, định giá và thanh toán nâng cao](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [Hướng dẫn quản lý nguồn lực](../project-service/implementation-guides/resource-management-guide.md)

 [Hướng dẫn báo cáo](../project-service/implementation-guides/reporting-guide.md)

 [Ghi chú cho nhà phát triển](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>Hướng dẫn cho các phiên bản cũ hơn (phiên bản ứng dụng 2.x hoặc 1.x)
 ...
 [Thời gian, chi phí và hợp tác](../project-service/time-expense-collaboration-guide.md)

 [Bạch thư (phiên bản ứng dụng 2.x hoặc 1.x)](../project-service/white-papers.md)

 [Ghi chú dành cho nhà phát triển (phiên bản ứng dụng 2.x)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
