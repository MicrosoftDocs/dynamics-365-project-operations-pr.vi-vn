...
1. Trong Project Service Automation (PSA), nhấp vào **Cài đặt** > **Giải pháp**, sau đó nhấp đúp vào **\<tên tổ chức > kích thước giá**. 
...
Bạn cũng cần thêm Chức vụ tiêu chuẩn vào các thực thể Giá Project Service, **Giá theo vai trò** và **Tăng giá theo vai trò**. Bạn cũng có thể hoàn tất việc này bằng cách sử dụng mối quan hệ 1:N giữa các thực thể **Chức vụ tiêu chuẩn** và **Giá theo vai trò** và các thực thể **Chức vụ tiêu chuẩn** và **Tăng giá theo vai trò**.
...
| Thực thể Project Service        | Các biểu mẫu cần trường mới   |Các dạng xem cần trường mới      |
| ------------------------------|---------------------------------|----------------------------------|
