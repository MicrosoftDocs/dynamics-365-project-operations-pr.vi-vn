...
## <a name="using-journals-to-record-costs"></a>Sử dụng nhật ký kế toán để ghi lại chi phí

Trong PSA, nhật ký kế toán cho phép bạn ghi lại chi phí hoặc doanh thu trong lớp giao dịch thuế, chi phí, thời gian, phí hoặc vật tư. Nhật ký kế toán có tiêu đề, các dòng và hành động **Xác nhận**. Dưới đây là một số tình huống mà bạn có thể sử dụng một nhật ký kế toán:
