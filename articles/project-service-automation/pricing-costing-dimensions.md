...
Do vậy, có 2 loại giá trị tham số giá trong Project Service Automation (PSA): 

- **Bộ tùy chọn** – Tham số là liệt kê cố định cho một bộ giá trị.
- **Giá trị dựa trên thực thể** – Tham số có thể là bộ giá trị thay đổi.
...
- [Thiết lập trường tùy chỉnh dưới dạng tham số giá](set-up-pricing-dimensions.md)
