...
> [!IMPORTANT]
> - Để dùng tính năng quản lý tài liệu SharePoint lưu trữ tệp [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] của bạn cho các dự án [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)], quản trị viên [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] của bạn cần phải bật tính năng quản lý tài liệu. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Bật quản lý tài liệu SharePoint cho các thực thể cụ thể](../admin/enable-sharepoint-document-management-specific-entities.md)  
...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>Tải một tệp Project lên SharePoint hoặc Nhóm Office  
 Bạn có thể tải tệp Project lên SharePoint và tìm thấy tệp đó trong Tài liệu Được liên kết cho dự án [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] của bạn.  Bạn cần phải yêu cầu quản trị viên đặt cấu hình tính năng quản lý tài liệu SharePoint rồi bật tính năng đó cho thực thể Dự án. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Thiết lập tích hợp SharePoint](../admin/set-up-sharepoint-integration.md)  

 Bạn cũng có thể tải tệp Project của mình lên [!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)] nếu đã thiết lập Nhóm Office. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Cộng tác với đồng nghiệp của bạn bằng cách sử dụng Office 365 Nhóm](../basics/collaborate-with-colleagues-using-office-365-groups.md)  
