...
description: Bài viết này cung cấp thông tin về các bản cập nhật chất lượng được cung cấp trong lần triển khai bản phát hành Project Operations tháng 3 năm 2021 cho tình huống dựa trên nguồn lực/hàng không trữ kho.
author: sigitac
ms.date: 03/03/2021
ms.topic: article
ms.prod: ''
...
- Quản lý dự án và kế toán trên môi trường ứng dụng Dynamics 365 Finance phiên bản 10.0.16 
