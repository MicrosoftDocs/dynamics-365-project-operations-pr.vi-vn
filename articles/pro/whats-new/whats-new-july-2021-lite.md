...
description: Bài viết này cung cấp thông tin về các bản cập nhật chất lượng có trong bản phát hành tháng 7 năm 2021 của triển khai bản đơn giản Project Operations.
author: sigitac
ms.date: 07/07/2021
ms.topic: article
ms.prod: ''
