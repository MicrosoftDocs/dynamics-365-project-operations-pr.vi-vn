...
| Lý do dẫn đến trạng thái | Trạng thái của hóa đơn nhà cung cấp. | <p>Trạng thái xác định vị trí của hóa đơn nhà cung cấp trong quy trình kinh doanh và liệu nó có thể được chỉnh sửa hay không. Dưới đây là một số giá trị có sẵn:</p><ul><li>**Bản thảo** - Hóa đơn của nhà cung cấp có thể được chỉnh sửa.</li><li>**Đã xác nhận** - Hóa đơn của nhà cung cấp đã được xác minh và xác nhận. Không thể chỉnh sửa hoặc xóa hóa đơn của nhà cung cấp ở trạng thái này.</li><li>**Đang tiến hành** - Hóa đơn của nhà cung cấp đang được xem xét. Hóa đơn của nhà cung cấp ở trạng thái này có thể được chỉnh sửa, nhưng không thể xóa chúng.</li><li>**Đã hủy** - Hóa đơn của nhà cung cấp đã bị hủy. Không thể chỉnh sửa hoặc xóa hóa đơn của nhà cung cấp ở trạng thái này.</li></ul> |
