---
title: Tạo lịch trình hóa đơn trên mô tả hợp đồng dự án
...
ms.locfileid: "9824747"
---
# <a name="create-invoice-schedules-on-a-project-contract-line"></a>Tạo lịch trình hóa đơn trên mô tả hợp đồng dự án
