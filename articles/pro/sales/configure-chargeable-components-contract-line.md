...
---
# <a name="configuring-chargeable-components-of-a-project-based-contract-line"></a>Đặt cấu hình các thành phần có thể tính phí của mục mô tả hợp đồng dựa trên dự án
...
Bạn có thể đặt cấu hình loại thanh toán của nhiệm vụ trên tab **Nhiệm vụ có thể tính phí** của mục mô tả hợp đồng bằng cách cập nhật trường **Loại thanh toán** trên lưới con nhiệm vụ cho mục mô tả hợp đồng. Hoặc, bạn có thể cập nhật trường **Loại thanh toán** trên lưới con của nhiệm vụ Thiết lập thanh toán của một dự án hiển thị các mục mô tả hợp đồng được liên kết với một nhiệm vụ.
...
Bạn có thể đặt cấu hình loại thanh toán của một giao dịch trên tab **Danh mục có thể tính phí** của mục mô tả hợp đồng dựa trên dự án. Để làm điều này, hãy cập nhật trường **Loại thanh toán** trên lưới con **Danh mục có thể tính phí**.
